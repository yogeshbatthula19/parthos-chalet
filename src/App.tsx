  ...
  return (
    <div className="app-container">
      ...
      <div className="floating-contact-buttons">
        ...
        >
          <svg className="fab-icon" viewBox="0 0 24 24" fill="currentColor" style={{ width: "24px", height: "24px" }}>
            <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.5-5.739-1.446L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.42 9.864-9.864.002-2.637-1.03-5.114-2.905-6.99C16.557 1.876 14.079 1.84 11.458 1.84c-5.438 0-9.863 4.42-9.867 9.864-.001 1.77.476 3.498 1.38 5.02L1.93 21.053l4.717-1.727c.001 0 .001 0 0 0zM17.486 14.4c-.3-.15-1.774-.875-2.048-.975-.275-.1-.475-.15-.675.15-.2.3-.775.975-.95 1.175-.175.2-.35.225-.65.075-.3-.15-1.267-.467-2.413-1.49-1.082-.966-1.812-2.158-2.025-2.508-.212-.35-.022-.54.152-.713.157-.156.3-.35.45-.525.15-.175.2-.3.3-.5.1-.2.05-.375-.025-.525-.075-.15-.675-1.625-.925-2.225-.244-.589-.49-.51-.675-.52H7.23c-.2 0-.525.075-.8.375-.275.3-1.05 1.025-1.05 2.5s1.075 2.9 1.225 3.1c.15.2 2.11 3.22 5.11 4.52.714.31 1.27.496 1.703.633.715.227 1.365.195 1.879.118.573-.085 1.774-.725 2.024-1.425.25-.7.25-1.3 1.175-1.425z"/>
          </svg>
        </a>
        <a 
          ...
          aria-label="Call Us"
        >
          <svg className="fab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: "22px", height: "22px" }}>
